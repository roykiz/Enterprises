...
'blog/post/share.html', {'post': post, 'form':
form, 'sent':sent})                    
...
def post_detail(request, year, month, day, post):
        ...
        return render(request,'blog/post/detail.html',{'post': post,'comments':comments,'new_comments':new_comment, 'comment_form':comment_form,
